...
_Разблокируем state из первой консоли_
...
[Ссылка на PR](https://github.com/beatljs/ter-homeworks/pull/1)
...
_Код с НЕ правильными адресами_
...
│   28: variable "ip_address" {
│     ├────────────────
│     │ var.ip_address is "1920.1680.0.1"
│ 
│ Given IP address is invalid.
│ 
│ This was checked by the validation rule at variables.tf:32,5-15.
╵
╷
│ Error: Invalid value for variable
│ 
│   on variables.tf line 38:
│   38: variable "ip_addresses" {
│     ├────────────────
│     │ var.ip_addresses is list of string with 3 elements
│ 
│ All elements must be valid IP addresses.
│ 
...
_Ну тут вообще просто_

```terraform
1. condition = can(regex("^[a-z]+$", var.any_string))

2. condition = (var.in_the_end_there_can_be_only_one.Connor != var.in_the_end_there_can_be_only_one.Dunkan)
```
...
│   49: variable "in_the_end_there_can_be_only_one" {
│     ├────────────────
...
│ 
│ This was checked by the validation rule at variables.tf:61,5-15.
╵
```
